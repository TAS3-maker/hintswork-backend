...
const { addSponsor, editSponsor, deleteSponsor, getAllSponsors, blockSponsor } = require("../controllers/sponsorController");
...
router.put("/block-sponsors/:id", authenticate, blockSponsor);
